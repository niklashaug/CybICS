...
Usage:
    python3 generate_mac.py <firmware.bin> <secret_file>
...
def generate_mac(firmware_path: str, secret_path: str) -> str:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print(f"Usage: {sys.argv[0]} <firmware.bin> <secret_file>", file=sys.stderr)
        sys.exit(1)
